...
class LinkedStack(object):
    ...
    def push(self, item):
        ...
        Running time: O(1) because we only have to change the linkedList head property """
        # Push given item
    ...
    def pop(self):
        ...
        Running time: O(1) because linkedList.delete method just finds the first index and removes it """
