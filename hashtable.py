...
class HashTable(object):
    ...
    def _resize(self, new_size=None):
        ...
        Best and worst case running time: O(2n+b) -> O(n+b) -> O(b) since b should be bigger than n based on our threshold
        ...
        # reinitialize our buckets and size by calling init funciton with new size
        # O(2b) -> O(b) time and space complexity
